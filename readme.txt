...
Also provides '{login_redirect_url}' which generates the url for the login page include a redirect to the url provided as the 'redirect_to' argument.
...
Configure your Caldera Form as usual.  Add the Redirect Processor and configure it to use '{get:redirect_to}'
...
The form can include a link to the login page using e.g.:
'If you have a user account please <a href={login_redirect_url} login here </a>'
